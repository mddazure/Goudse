...
az network vwan create -g $rgname -l swedencentral -n vwan-0
az network vwan create -g $rgname -l swedencentral -n vwan-1


az network vhub create -g $rgname -n hub-0 -l swedencentral --addressprefix 192.168.0.0/24 --vwan-0 --no-wait
az network vhub create -g $rgname -n hub-2 -l swedencentral --addressprefix 192.168.2.0/24 --vwan-0 --no-wait
az network vhub create -g $rgname -n hub-1 -l swedencentral --addressprefix 192.168.1.0/24 --vwan-1 --no-wait
